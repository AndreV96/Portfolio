...
import {faLinkedin, faGithub, faWhatsapp ,faStackOverflow} from '@fortawesome/free-brands-svg-icons'
...
function Footer() {
  return (
    <div className="App py-3 bg-dark bg-gradient">
      ...
      <a href="https://stackoverflow.com/users/18910833/andr%c3%a9-vega" target="_blank"><FontAwesomeIcon icon={faStackOverflow} className="me-3 footer-icons"/></a>
